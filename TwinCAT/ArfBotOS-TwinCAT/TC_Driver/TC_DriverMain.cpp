...
class CTC_DriverCtrl : public ITcOCFCtrlImpl<CTC_DriverCtrl, CTC_DriverClassFactory>
{
public:
	CTC_DriverCtrl() {};
	virtual ~CTC_DriverCtrl() {};
};
...
{
	HRESULT hr = E_FAIL;
	TRACE("TC_Driver: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CTC_DriverCtrl>;
