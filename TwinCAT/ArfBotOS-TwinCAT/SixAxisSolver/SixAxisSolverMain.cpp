...
class CSixAxisSolverCtrl : public ITcOCFCtrlImpl<CSixAxisSolverCtrl, CSixAxisSolverClassFactory>
{
public:
	CSixAxisSolverCtrl() {};
	virtual ~CSixAxisSolverCtrl() {};
};
...
{
	HRESULT hr = E_FAIL;
	TRACE("SixAxisSolver: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CSixAxisSolverCtrl>;
