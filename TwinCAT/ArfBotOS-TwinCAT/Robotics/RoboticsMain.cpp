...
class CRoboticsCtrl : public ITcOCFCtrlImpl<CRoboticsCtrl, CRoboticsClassFactory>
{
public:
	CRoboticsCtrl() {};
	virtual ~CRoboticsCtrl() {};
};
...
{
	HRESULT hr = E_FAIL;
	TRACE("Robotics: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CRoboticsCtrl>;
