...
class CKinematicsCtrl : public ITcOCFCtrlImpl<CKinematicsCtrl, CKinematicsClassFactory>
{
public:
	CKinematicsCtrl() {};
	virtual ~CKinematicsCtrl() {};
};
...
{
	HRESULT hr = E_FAIL;
	TRACE("Kinematics: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CKinematicsCtrl>;
