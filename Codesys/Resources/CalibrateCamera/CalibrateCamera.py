...
def save_cal_data(checkerboard, squaresize, matrix, distortion, pixelratio, rotation_offset, top_left, bot_right, path):
...
def main(checkerboard, squaresize, resultfile, debug, width, height):
    ...
    if ret == True:
        ...
        top_left = get_top_left(corners, checkerboard)
        ...
        save_cal_data(checkerboard, squaresize, mtx, dist, pixel_ratio, rotation_offset, top_left, bot_right, cal_file_path)
